      ...
      <form onSubmit={handleSearch} className="relative">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2 pl-10 pr-4 text-sm border-2 border-gray-400 rounded-full focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent placeholder-gray-600"
          />
          <button
            type="submit"
