...
export default function FAQPage() {
  ...
  const faqItems: FAQItem[] = [
    ...
    // Envíos
    { id: 8, category: 'envios', question: '¿Cuáles son los costos de envío?', answer: 'Los costos de envío varían según el destino y peso del paquete. El envío estándar dentro de Manabi cuesta $3.5, y a otras ciudades desde $4. Envíos gratuitos en compras mayores a $50.' },
